...
- After computing the numeric answer, output a tool call using: FUNCTION_CALL: draw_rectangle_with_text|[numeric answer]
...
- FINAL_ANSWER: [42] 
- FUNCTION_CALL: draw_rectangle_with_text|42 #Called after the FINAL_ANSWER
